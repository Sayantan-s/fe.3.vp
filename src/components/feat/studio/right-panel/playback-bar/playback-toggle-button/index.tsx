...
} from "@/components/stories/atoms/icon-button";
import {
  EPlaybackState,
...
function deriveMode(
  ...
  if (
    ...
    return EPlaybackState.Replay;
  }
  return playbackState as EPlaybackState;
}
...
function PlayIcon(props: SubProps) {
  ...
  if (!ctx || ctx.mode !== EPlaybackState.Play) return null;
  return (
    <IconButton
      icon={Play}
      aria-label="Play"
